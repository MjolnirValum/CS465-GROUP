...
#include<gl/glut.h>
//#include <GLUT/GLUT.h>
#include <c:\Users\clayt\source\repos\Updated-Project-3\Updated-Project-3\Bitman.h>
#include <c:\Users\clayt\source\repos\Updated-Project-3\Updated-Project-3\Support.h>
#include <c:\Users\clayt\source\repos\Updated-Project-3\Updated-Project-3\Unnamed.h>
#include <math.h>
#include <iostream>
...
//the void drawSupport I have commented out was put into Support.cpp
//ensuring the same call (void drawSupport()) is on the Support.cpp's header file (Support.h)
//and that Support.h file is included in the beginning of main.cpp, all works.
//just gotta make sure to fix things about declarations
//going to try and get my character to fit in somewhere now, lol.
...
//attempting to use the Unnamed.h/Unnamed.cpp combo like with drawSupport()
//void buildUnnamed();
...
void display(void) //All camera from Demo
{
    ...
    drawSupport();
    glTranslatef(0.5, 1.6, 5);
    buildUnnamed();
    glTranslatef(-10, -0.6, 4);
    glRotatef(angle, 0, 1, 0);

    displayBitman4();//included this using Bitman.cpp/Bitman.h

    //glRotatef(-angle, 1, 1, 1);  buildUnnamed(); /////if you wanna see something funny, uncomment this
